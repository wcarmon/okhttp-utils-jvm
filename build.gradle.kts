...
val mvnArtifactId = "okhttp-utils-jvm" // see settings.gradle.kts
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = mvnArtifactId
                description = "Utilities for using OkHTTP"
                url = "https://github.com/wcarmon/okhttp-utils-jvm"

                licenses {
                    license {
                        name = "MIT License"
                        url =
                            "https://raw.githubusercontent.com/wcarmon/okhttp-utils-jvm/main/LICENSE"
                    }
                }
                ...
                scm {
                    connection =
                        "scm:git:git@github.com:wcarmon/okhttp-utils-jvm.git"
                    developerConnection =
                        "scm:git:ssh://github.com:wcarmon/okhttp-utils-jvm.git"
                    url = "https://github.com/wcarmon/okhttp-utils-jvm/tree/main"
                }
            }
        }
    }
